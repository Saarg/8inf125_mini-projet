...
//------------------------------ ctor -----------------------------------------
//-----------------------------------------------------------------------------
Goal_FollowPathSideToSide::Goal_FollowPathSideToSide(Raven_Bot*pBot,
						std::list<PathEdge> path):Goal_Composite<Raven_Bot>(pBot, goal_follow_path_side_to_side),
							m_Path(path)
	{
	}
	...
	void Goal_FollowPathSideToSide::Activate()
{
	...
	default:
		...
		throw std::runtime_error("<Goal_FollowPathSideToSide::Activate>: Unrecognized edge type");
	}
}
...
//-------------------------- Process ------------------------------------------
//-----------------------------------------------------------------------------
int Goal_FollowPathSideToSide::Process()
{
...
//---------------------------- Render -----------------------------------------
//-----------------------------------------------------------------------------
void Goal_FollowPathSideToSide::Render()
{
