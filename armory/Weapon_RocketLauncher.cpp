...
void RocketLauncher::InitializeFuzzyModule()
{
	...
	FzSet& Target_Close = DistToTarget.AddTriangularSet("Target_Close", 25, 50, 300);
	FzSet& Target_Medium = DistToTarget.AddTriangularSet("Target_Medium", 50, 300, 450);
	FzSet& Target_Far = DistToTarget.AddTriangularSet("Target_Far", 300, 450, 600);
	FzSet& Target_VeryFar = DistToTarget.AddRightShoulderSet("Target_VeryFar", 450, 600, 1000);
